...
router.post('/new',
// [body('Name').notEmpty().withMessage('Name is required').isLength({min:2, max:150}).isAlpha().withMessage('Please enter a valid Name'),
// body('Email').notEmpty().withMessage('Email is required').isEmail().withMessage('Please enter a valid Email'),
// body('Age').notEmpty().withMessage('Age is required').isNumeric().withMessage('Please enter a valid Age')
// ]
